...
public class Calulate {
    ...
    public static void main(String[] args) {
     // 几个测试数据
        System.out.println(executeExpression(" 2+3/2 * 3 - 4 *(2 + 5 -2*4/2+9) + 3 + (2*1)-3= "));
        System.out.println(executeExpression("9*2+1/3*2-4+(3*2/5+3+3*6)+3*5-1+3+(4+5*1/2)="));
        System.out.println(executeExpression(" 9.2 *(20-1)-1+199 = "));
        System.out.println(executeExpression(" 9.2 *(20-1)-1+199  "));
        System.out.println(executeExpression(" 9.2 *(20-1)-1+199"));
        System.out.println(executeExpression(" 9 *(20-1)-(1+199) "));
        System.out.println(executeExpression("1000000000000*1000000000000 = "));
    }
